  ...
  return (
   ...
   <div className=" flex flex-col lg:flex-row justify-between">
    ...
    <div className="flex justify-between max-w-[390px]">
        <button onClick={()=> filterPrice("$")} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '>Low</button>
        <button onClick={()=> filterPrice("$$")} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '>Medium</button>
        <button onClick={()=> filterPrice("$$$")} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '>High</button>
        <button onClick={()=> filterPrice("$$$$")} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '>Highest</button>
        </div>  
     </div>
    </div>
